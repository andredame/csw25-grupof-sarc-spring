...
import br.com.sarc.csw.auth.dto.RoleDetailResponse;
import br.com.sarc.csw.auth.dto.RoleRequest;
import br.com.sarc.csw.auth.dto.RoleResponse;
...
public class RoleService {
    ...
    public void createRole(String token, RoleRequest roleRequest) {
        webClient.post()
                .uri(keycloakUrl + "/apiadmin/realms/" + realm + "/roles")
